...
public class MainActivity extends AppCompatActivity {
    ...
    /*摄像头管理器CameraManager：位于android.hardware.camera2.CameraManager下，也是Android 21(5.0)添加的，
    ...
    */
     ...
     * https://developer.android.google.cn/reference/android/hardware/camera2/CameraDevice  */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //以下开始自己的代码...注意：把请求照相机权限的代码放在最前面

        //CXH20241006，早期Android只需要在安装的时候请求权限即可，某个SDK版本后（Android 6.0及以上）需要在运行时请求权限
        ...
        if (ContextCompat.checkSelfPermission(this, android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED)
        {
            ...
            makeText(this, "Get CAMERA Permission", LENGTH_SHORT).show(); // 用户允许读文件权限请求，显示提示消息
        }
    ...
    private void openCamera() {
        ...
        if (mImageReader == null){
            /*CXH20181007：调试例子的过程中发现 TextureView 的尺寸如果和Android中支持的不一致时，无法生成预览，故在示例中手工强制设置为1280*720*/
            mImageReader = ImageReader.newInstance(1280, 720, ImageFormat.JPEG, 3);
            mImageReader.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() {
                //可以在这里处理拍照得到的临时照片 例如，写入本地，或者通过网络发送
                @Override
...
//                }
            ...
            makeText(MainActivity.this, ">>>Open Camera", LENGTH_SHORT).show();
    ...
    private CameraDevice.StateCallback stateCallback = new CameraDevice.StateCallback() {
        ...
        public void onError(@NonNull CameraDevice camera, int error) {
            ...
            //有错误
            Log.e(TAG,"摄像头开启失败");
            makeText(MainActivity.this, ">>>摄像头开启失败", LENGTH_SHORT).show();
        ...
        try {
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(surface,mImageReader.getSurface()), new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigureFailed(@NonNull CameraCaptureSession session) {
                    Log.e(TAG,"配置错误");
                    makeText(MainActivity.this, ">>>配置错误", LENGTH_SHORT).show();
                }
            }, null);
